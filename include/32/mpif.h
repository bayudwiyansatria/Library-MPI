...
!
!   "@(#)IBM Platform MPI 09.01.04.03 [BASELINE_MPI_STREAM_REL_9.1.4.0_RTM_2015_06_15]  [] [] [] [] [] [] (02/06/2018) Linux IA32"
!
...
!
       ...
       parameter (PLATFORM_MPI=Z'09010403')
...
!
       ...
       integer MPI_ERR_SERVICE, MPI_ERR_NAME, MPI_ERR_CONNECT
       integer MPI_ERR_EXITED, MPI_ERR_REVOKED, MPI_ERR_PROC_FAILED
       ...
       parameter (MPI_ERR_EXITED=54)
       parameter (MPI_ERR_CONNECT=55)
       parameter (MPI_ERR_PROC_FAILED=56)
       parameter (MPI_ERR_REVOKED=57)
