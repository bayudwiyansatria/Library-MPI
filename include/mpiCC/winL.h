 ...
 */
  ...
  //
  virtual void AccumulateL(const void* origin_addr, MPI::Aint origin_count,
			  const MPI::Datatype& origin_datatype,
			  int target_rank, MPI::Aint target_disp,
			  MPI::Aint target_count,
			  const MPI::Datatype& target_datatype,
			  const MPI::Op& op) const;

  static  Win CreateL(const void* base, MPI::Aint size, MPI::Aint disp_unit,
		     const MPI::Info& info, const MPI::Intracomm& comm);

  virtual void GetL(const void *origin_addr, MPI::Aint origin_count,
		   const MPI::Datatype& origin_datatype, int target_rank,
		   MPI::Aint target_disp, MPI::Aint target_count,
		   const MPI::Datatype& target_datatype) const;

  virtual void PutL(const void* origin_addr, MPI::Aint origin_count,
		   const MPI::Datatype& origin_datatype, int target_rank,
		   MPI::Aint target_disp, MPI::Aint target_count,
		   const MPI::Datatype& target_datatype) const;
